...
def create_initial_state(
    ...
    This is the starting state S0 of the state machine.
...
def handoff(
    ...
    This is the transition function d(S, I) of the state machine:
...
def aggregate_recommendation(state: OrchestratorState) -> OrchestratorState:
    """
    The output function l(S) of the state machine.
    ...
    Signal fusion logic:
      ...
      3. Weighted average = sum(score * confidence) / sum(confidence)
